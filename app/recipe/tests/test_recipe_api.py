...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_create_recipe_with_ingredient(self):
        ...
        ingredient1 = sample_ingredient(user=self.user, name='Biscuits')
    ...
    def test_full_update_recipe(self):
        """Test updatting a recipe with ut"""
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
        payload = {
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipe_by_tags(self):
        """Test returning recipes woth specific tags"""
        recipe1 = sample_recipe(user=self.user, title='Thai Vegetable')
        recipe2 = sample_recipe(user=self.user, title='Shopska')
        tag1 = sample_tag(user=self.user, name='Vegan')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Tai Chicken')
